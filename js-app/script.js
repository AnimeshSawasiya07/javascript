   ...
   // cardContainer.setAttribute("style","display:flex;");
    ...
    for(let data of items){
       ...
       // col.setAttribute("style","border:1px solid black;");
        ...
        div.setAttribute("style","height:350px;width:100%;margin-top:20px;margin-bottom:20px; box-shadow:1px 1px 10px 1px;")
        ...
        price.setAttribute("class","bi bi-currency-rupee")
